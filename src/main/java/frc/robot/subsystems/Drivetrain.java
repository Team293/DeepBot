...
public class Drivetrain extends Subsystem 
{
    ...
    private final double LEFT_LEAD_TALON_CAN_ID = 0;
    private final double LEFT_FOLLOWER_TALON_CAN_ID = 1;
    private final double RIGHT_LEAD_TALON_CAN_ID = 2;
    private final double RIGHT_FOLLOWER_TALON_CAN_ID = 3;
