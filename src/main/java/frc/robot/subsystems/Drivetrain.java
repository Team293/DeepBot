...
public class Drivetrain extends SubsystemBase
{
    ...
    */
    public Drivetrain()
    {
        ...
        //m_left = new SpeedControllerGroup(rightMotor1, rightMotor2);
    ...
    public void dumbDrive(double leftPos, double rightPos) 
    {
        ...
        m_leftMotorLead.set(retval * VELOCITY_LIMIT_PERCENTAGE);    

        retval = clampInput(rightPos, m_deadband);
        m_rightMotorLead.set(retval * VELOCITY_LIMIT_PERCENTAGE);    
    }
    ...
    {
        m_differentialDrive.arcadeDrive(forwardMovement * VELOCITY_LIMIT_PERCENTAGE, turning);
    }
