...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("VelocityDrive", new VelocityDrive( m_drivetrain, rightJoy, leftJoy));
    SmartDashboard.putData("DumbDrive", new DumbDrive( m_drivetrain, rightJoy, leftJoy));
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
    SmartDashboard.putData("ArcadeDrive", new ArcadeDrive(m_drivetrain, xboxController));
    SmartDashboard.putData("ArcadeDriveForza", new ArcadeDriveForza( m_drivetrain ));
    ...
    //Set ArcadeDrive as default drive method
